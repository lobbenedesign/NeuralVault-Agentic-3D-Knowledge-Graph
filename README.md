...
> **È un Sovereign Cognitive Engine progettato per l'evoluzione autonoma della conoscenza e dell'architettura software sulla base degli imprinting di memoria che l'utente vuole dare alla nebula, può essere utilizzato con vari LLM, possono essere integrati anche LLM custom e possono essere utilizzati LLM open source tramite ollama (Qwen, Llama 3.1 e tanti altri) .**
